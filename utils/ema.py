"""
Reference: https://github.com/hankyul2/EfficientNetV2-pytorch/blob/main/utils/ema.py
"""
...
class EMACallback(Callback):
    ...
    def on_pretrain_routine_start(
        ...
        modules = list(
            filter(
                lambda x: len(list(x[1].parameters())) > 0, pl_module.named_children()
            )
        )
        ...
        for name, module in modules:
            ...
            module.forward = forward_wrapper(
                module, module.forward_bc, ema_module.forward
            )
